    ...
    <Section className="border-t border-border">
      <div className="mx-auto flex max-w-6xl flex-col gap-6 rounded-3xl border border-border/40 bg-muted/40 p-8 text-left sm:p-12">
        <div className="space-y-3">
          <p className="text-xs uppercase tracking-[0.4em] text-muted-foreground">Proven, even early</p>
        ...
        <div className="flex flex-col gap-4 rounded-2xl border border-border bg-background p-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-sm font-semibold text-foreground">Dispute Ninja</p>
            <p className="text-xs uppercase tracking-[0.4em] text-muted-foreground">SERP snapshot</p>
            <p className="text-foreground">#1 • Data disputes <span className="text-muted-foreground">/ 2 weeks</span></p>
          </div>
          <a
