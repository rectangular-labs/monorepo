...
const plans = [
  {
    ...
    description: "Hire your first AI SEO employee and get moving fast.",
    features: [
      "Site understanding crawl",
      "3 campaigns / month",
      "Intent scoring & keyword clusters",
      "Basic forecasting",
      "Calendar scheduling (1 calendar)",
      "Email support",
    ],
  ...
  },
  {
    ...
    description: "End‑to‑end campaigns with forecasts you can plan around.",
    features: [
      "Everything in Starter",
      "Unlimited campaigns",
      "Advanced forecasting & reporting",
      "Content calendar & reminders",
      "Integrations (CMS, Search Console, Analytics)",
      "Priority support",
    ],
  ...
  },
  {
    ...
    description: "Security, compliance, SLAs, and bespoke workflows.",
    features: [
      "Custom onboarding & SSO",
      "Role‑based access control",
      "SOC2/ISO requests supported",
    ...
    >
      <div className="flex flex-col items-center justify-center gap-8">
        <div className="flex flex-col items-center space-y-2">
          ...
          >
            Pick a plan that fits today. Upgrade when you grow.
          </motion.h1>
          <motion.p
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Pricing that scales with your team. No hidden fees. Cancel anytime.
          </motion.p>
        </div>
