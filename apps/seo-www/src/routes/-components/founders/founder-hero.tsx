...
export const FounderHero = () => {
  ...
  return (
    <Section className="relative z-10">
      <div className="mx-auto max-w-4xl space-y-6 pt-10 text-center sm:pt-14">
        ...
        <p className="mx-auto max-w-xl text-lg text-muted-foreground sm:text-xl">
          Fluid Posts is an End-to-End SEO tool built to think like a business
        ...
        <div className="pt-2">
          ...
          <p className="mx-auto mt-2 max-w-3xl text-muted-foreground text-sm leading-relaxed">
            ...
            <span className="font-semibold text-foreground">#1 on Google</span>{" "}
            and appear on{" "}
            <span className="font-semibold text-foreground">ChatGPT</span> for
            targeted terms within a month.
          </p>

          <div className="mx-auto mt-2 max-w-3xl">
            <div className="rounded-2xl border border-border bg-background/40 p-5 text-left">
              <p className="mt-2 text-center font-bold text-[10px] text-muted-foreground uppercase tracking-widest">
                Pilot highlight
              </p>
