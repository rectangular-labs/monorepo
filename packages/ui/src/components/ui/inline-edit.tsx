...
const inlineEditVariants = cva(
  "relative inline-flex items-center gap-2 transition-colors focus-within:outline-none",
  {
    variants: {
      variant: {
        default: "rounded-md px-2 hover:bg-muted/50",
        ghost: "hover:bg-transparent",
        outline:
          "rounded-md border border-input px-2 hover:bg-accent hover:text-accent-foreground",
      },
      size: {
        default: "text-base",
        sm: "text-sm",
  ...
  (
    ...
    const renderInput = () => {
      const inputProps = {
        ...
        className: cn(
          "flex h-full w-full bg-transparent px-0 py-0 ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
          size === "lg" && "text-lg",
          size === "sm" && "text-sm",
      ...
      return (
        <div className="ml-2 flex items-center gap-1">
          <button
            ...
            className="inline-flex h-6 w-6 items-center justify-center rounded-sm bg-primary text-primary-foreground hover:bg-primary/90 disabled:opacity-50"
          ...
          <button
            ...
            className="inline-flex h-6 w-6 items-center justify-center rounded-sm bg-muted text-muted-foreground hover:bg-muted/80 disabled:opacity-50"
            disabled={isSaving}
