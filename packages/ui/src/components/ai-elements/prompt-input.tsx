...
import {
  ...
  HoverCardContent,
  HoverCardTrigger,
} from "@rectangular-labs/ui/components/ui/hover-card";
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
...
interface SpeechRecognition extends EventTarget {
  ...
  stop(): void;
  onstart:
    | ((this: SpeechRecognition, ev: Event) => void | Promise<void>)
    | null;
  onend: ((this: SpeechRecognition, ev: Event) => void | Promise<void>) | null;
  onresult:
    | ((
